...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Luis Bezerra!",
    'Software engineer focused on back-end development and artificial intelligence,',
    'building scalable APIs, intelligent systems, and practical AI-powered solutions.',
  ],
  skills: () => [
    'Technical Skills:',
    '  Languages:  TypeScript, JavaScript, Python',
    '  Backend:    Node.js, NestJS, FastAPI, Django REST Framework',
    '  AI:         LLMs, RAG, Multi-Agent Systems, Computer Vision, OCR',
    '  Database:   PostgreSQL, MongoDB, Redis, SQLite, DynamoDB',
    '  DevOps:     Docker, AWS',
    '  Frontend:   React, Next.js, Angular',
    '  Tools:      VS Code, Git, Linux, OpenCode, Insomnia, DBeaver, Obsidian',
  ],
  contact: () => [
    'Contact Information:',
    '  Email:    luisbezerra.work@gmail.com',
    '  GitHub:   github.com/joseluisbezerra',
    '  LinkedIn: linkedin.com/in/luis-bezerra',
  ],
  themes: () => [
    'Available themes:',
  ...
  ls: () => ['home.tsx', 'about.html', 'projects.py', 'contact.json', 'github.md'],
